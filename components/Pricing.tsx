    ...
    <section className="overflow-hidden py-24  text-neutral-800 dark:text-neutral-50 lg:pb-32">
      <div className="container mx-auto px-4">
        <div className="mx-auto mb-20 max-w-2xl text-center">
          ...
          Flexible plans tailored to your needs, ensuring you only pay for what you use.
          </p>
        </div>
              ...
              <div className="border-b border-neutral-300 p-12 dark:border-neutral-600">
                <div className="pr-9">
                  ...
                  <p className="tracking-tight">
                    The perfect plan for small teams or individuals.
                  </p>
                </div>
              </div>
              <div className="p-12 pb-11">
                <ul className="-m-1.5 mb-11">
                  <FeatureItem>50 Participants</FeatureItem>
                  <FeatureItem>1 Event</FeatureItem>
          ...
          <div className="w-full p-6 md:w-1/2 lg:w-1/3">
            ...
            >
              <div className="h-full rounded-2xl bg-white dark:bg-neutral-900">
                ...
                >
                  <div className="pr-9">
                    ...
                    <p className="mb-2 text-xl font-semibold tracking-tighter text-white">
                      From 2% + ₹5 <span className="text-base">/ per Ticket</span> 
                    </p>
                    <p className="tracking-tight text-white">
                      The ideal plan for businesses who require heavy
                      usage.
                    </p>
                  </div>
                </div>
                <div className="p-12 pb-11">
                  <ul className="-m-1.5 mb-11">
                    <FeatureItem>Designed For Paid Events</FeatureItem>
                    <FeatureItem>Unlimited Participants Onboarding</FeatureItem>
                    <FeatureItem>User Friendly Dashboard</FeatureItem>
                    <FeatureItem>Detailed Analytics</FeatureItem>
                    <FeatureItem>Host Unlimited Events</FeatureItem>
                    <FeatureItem>Dynamic QR Ticketing</FeatureItem>
